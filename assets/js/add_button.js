/* 創建 Div 元素 */
var element1 = document.getElementById("under"); //最外層元素 ID
...
if (element1 != null) {
    ...
    /* 創建按鈕元素 */
    var element2 = document.getElementById("answerDiv"); //最外層元素 ID
    ...
    if (element2 != null && getTitle != null) {
        ...
        buttonCreate.style = "font-size: 20px; padding: 6px 15px;"; //設定 div style
