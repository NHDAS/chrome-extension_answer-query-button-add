...
function createQueryAnswerButton() {
    ...
    if (element1 != null) {
        ...
        //const pagePrev = document.getElementsByClassName("prev")[0].getElementsByTagName("button")[0]; //取得上一題按鈕
        //const pageNext = document.getElementsByClassName("next")[0].getElementsByTagName("button")[0]; //取得下一題按鈕
